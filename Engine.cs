...
namespace PhysicsEngineCore {
    ...
    public class Engine : Core {
        ...
        public void OnRendering(object? sender, EventArgs e) {
            this.render.Update(this.content.objectCount,this.content.groundCount,this.content.entities.Count);
        ...
        public void Import(string rawSaveData) {
            ...
            this.SpawnObjects(saveData.GetAllObjects());
            this.SpawnGrounds(saveData.GetAllGrounds());
            this.SpawnEffects(saveData.GetAllEffects());
